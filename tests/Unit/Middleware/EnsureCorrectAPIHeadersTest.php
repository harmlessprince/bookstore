...
class EnsureCorrectAPIHeadersTest extends TestCase
{
    ...
    {
        $request = HttpRequest::create('/test', 'POST');
        $request->headers->set('accept', 'application/vnd.api+json');
        $middleware = new EnsureCorrectAPIHeaders;
    ...
    {
        $request = HttpRequest::create('/test', 'PATCH');
        $request->headers->set('accept', 'application/vnd.api+json');
        $middleware = new EnsureCorrectAPIHeaders;
     ...
     * 
     */
    public function it_accepts_post_request_if_accept_header_adheres_to_json_api_spec()
    {
        $request = HttpRequest::create('/test', 'POST');
        $request->headers->set('accept', 'application/vnd.api+json');
     ...
     * 
     */
    public function it_accepts_patch_request_if_accept_header_adheres_to_json_api_spec()
    {
        $request = HttpRequest::create('/test', 'PATCH');
        $request->headers->set('accept', 'application/vnd.api+json');
        $request->headers->set('content-type', 'application/vnd.api+json');
